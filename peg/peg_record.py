...
for i_episode in range(50):
    ...
    for t in range(2000):
        if state == 0:
            target = [target_position[0], target_position[1], target_position[2] + 0.05, 0.024]
        elif state == 1:
            target = [target_position[0], target_position[1], target_position[2] + 0.03,  0.024]
        elif state == 2:
        ...
        if done:
            ...
            name = "demonstrations/peg/peg_%d.txt" % (demo)
